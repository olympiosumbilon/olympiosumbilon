    ...
    <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end">
      ...
      <div className={`flex flex-col gap-3 mb-4 transition-all duration-300 transform ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
        ...
        >
          ...
          <span className="text-gray-700 dark:text-gray-200 font-semibold text-sm">WhatsApp</span>
        </a>
        ...
        >
          ...
          <span className="text-gray-700 dark:text-gray-200 font-semibold text-sm">Messenger</span>
        </a>
      </div>
      ...
      <button
        onClick={toggleMenu}
        className={`flex items-center justify-center px-6 py-3 bg-[#e8a030] text-white rounded-full shadow-2xl hover:shadow-orange-500/20 hover:scale-105 transition-all duration-300 group`}
      >
