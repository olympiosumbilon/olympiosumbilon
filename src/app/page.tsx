          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://twitter.com/olympiosumbilon" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-[#e8a030] rounded-full flex items-center justify-center transition-all duration-300">
