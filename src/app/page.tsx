    ...
    <main className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-300">
              ...
              <div className="text-center border-t border-white/10 pt-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <a 
                    ...
                    className="flex items-center px-8 py-3 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 group w-full sm:w-auto justify-center"
                  >
                    <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center px-8 py-3 bg-[#1877F2] hover:bg-[#0d65d9] text-white rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 group w-full sm:w-auto justify-center"
                  >
                    <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#0084FF] hover:bg-[#0066CC] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#25D366] hover:bg-[#128C7E] text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group"
